...
print(f"Idiosyncratic variance: {idiosync_var:.2f}")
...
plt.bar(['Common', 'Idiosync'], [explained_ratio*total_var, idiosync_var], color=['skyblue','salmon'])
plt.ylabel('Variance')
plt.title('Variance Decomposition')
plt.tight_layout()
plt.savefig("figure/variance_decomposition.png")
plt.show()
plt.close()
